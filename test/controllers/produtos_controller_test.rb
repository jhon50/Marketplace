...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { imagem: @produto.imagem, nome: @produto.nome, parcelas: @produto.parcelas, preco: @produto.preco, url: @produto.url } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { imagem: @produto.imagem, nome: @produto.nome, parcelas: @produto.parcelas, preco: @produto.preco, url: @produto.url } }
